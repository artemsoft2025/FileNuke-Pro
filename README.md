...
1. **Умная структурная порча** - анализирует тип файла и целенаправленно разрушает его критичные области, программы для восстановления данных не помогут (R.saver,  R-Studio, Recuva). Возможно дорогая криминалистика и поможет восстановить файлы удаленные данным способом, но главный смысл тут в том, что рядовые пользователи не смогу восстановить ваша данные без огромного вложения финансовых средств (взамен получаем экономию времени и ресурсов диска).
